...
export function generateSampleData(numberOfRows: number): any[] {

    var arrCounties: string[] = ["Kent", "Sussex", "Devon"];
    var arrImages: string[] = ["fa-taxi", "fa-cloud-download", "fa-bug", "fa-glass", "fa-bank", "fa-area-chart", "fa-arrow-up", "fa-arrow-down"];
    var arrCurrencies: string[] = ["USD", "GBP", "EUR"];
