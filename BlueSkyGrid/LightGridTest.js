define(["require", "exports", './LightGridController', './SampleData', './CurrencyManager'], function (require, exports, __gc, __data, __cm) {
    // -------------------------------------------------------------------------------------
    // Grid Light portlet - full experimental grid
    // -------------------------------------------------------------------------------------
    var GridLightExample = (function () {
        function GridLightExample() {
            this._$comment = undefined;
        }
        GridLightExample.prototype.prepare = function () {
        ...
        GridLightExample.prototype.populateData = function (rowcount) {
            var self = this;
        ...
        return GridLightExample;
    })();
    exports.GridLightExample = GridLightExample;
});
